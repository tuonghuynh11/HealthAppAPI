...
import { CHAT_MESSAGES, DISH_MESSAGES, REPORT_MESSAGES, STATISTIC_MESSAGES } from '~/constants/messages'
...
export const getStatisticAboutTopController = async (req: Request<ParamsDictionary, any, any, any>, res: Response) => {
  const rersult = await statisticService.getTop()
  return res.json({
